...
namespace ProyectoP1Bancos.Controllers
{
    public class CuentasController : Controller
    {
        ...
        public CuentasController(ProyectoP1BancosContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdCuenta,NumCuenta")] Cuenta cuenta)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdCuenta,NumCuenta")] Cuenta cuenta)
        {
